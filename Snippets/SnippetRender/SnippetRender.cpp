...
void setupDefaultRenderState()
{
	...
	glClearColor(119.f/255.f, 136.f/255.f, 153.f/255.f, 1.0);
...
void renderLine(const PxVec3& start, const PxVec3& end, const PxVec3& color)
{
	glBegin(GL_LINES);
...
void CalculateFrameRate()
{
	...
	{
		float fps = int(framesPerSecond) / (currentTime - lastTime);
		printf("Current Frames Per Second: %f\n", fps);
